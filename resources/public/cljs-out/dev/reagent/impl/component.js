...
if((i < len)){
var k = (ks[i]);
var G__10586 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__10587 = (i + (1));
m = G__10586;
i = G__10587;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__10588 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__10588) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__10588));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__10590 = c;
var G__10590__$1 = (((G__10590 == null))?null:G__10590.prototype);
if((G__10590__$1 == null)){
return null;
} else {
return (G__10590__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__10592 = c;
var G__10592__$1 = (((G__10592 == null))?null:G__10592.prototype);
if((G__10592__$1 == null)){
return null;
} else {
return (G__10592__$1["render"]);
}
})() == null)))));
});
...
var G__10594 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__10594) : reagent.impl.component.as_element.call(null,G__10594));
};
...
var _STAR_current_component_STAR__orig_val__10600 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__10601 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__10601;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__10600;
}});
...
var G__10602 = key;
var G__10602__$1 = (((G__10602 instanceof cljs.core.Keyword))?G__10602.fqn:null);
switch (G__10602__$1) {
...
return ((function (G__10602,G__10602__$1){
...
var c = this;
var G__10607_10609 = (c["cljsRatom"]);
if((G__10607_10609 == null)){
} else {
reagent.ratom.dispose_BANG_(G__10607_10609);
}
...
var renders_10611 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_10612 = cljs.core.first(cljs.core.vals(renders_10611));
if((cljs.core.count(renders_10611) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_10611))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_10612)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_10612], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__10610 = name;
switch (G__10610) {
case "":
...
var G__10615 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__10615) : reagent.impl.component.global$module$create_react_class.call(null,G__10615));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__10616 = fiber;
var G__10616__$1 = (((G__10616 == null))?null:(G__10616["type"]));
if((G__10616__$1 == null)){
return null;
} else {
return (G__10616__$1["displayName"]);
}
})();
var parent = (function (){var G__10617 = fiber;
if((G__10617 == null)){
return null;
} else {
return (G__10617["return"]);
}
})();
var path = (function (){var G__10618 = parent;
var G__10618__$1 = (((G__10618 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__10618) : reagent.impl.component.fiber_component_path.call(null,G__10618)));
if((G__10618__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10618__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__4131__auto__ = (function (){var G__10620 = c;
if((G__10620 == null)){
return null;
} else {
return (G__10620["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__10621._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__10623 = c;
if((G__10623 == null)){
return null;
} else {
return (G__10623["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__10625 = c;
if((G__10625 == null)){
return null;
} else {
return G__10625._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__10627 = instance;
if((G__10627 == null)){
return null;
} else {
return (G__10627["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__10628 = instance;
if((G__10628 == null)){
return null;
} else {
return G__10628._currentElement;
}
}
})();
var name = (function (){var G__10629 = elem;
var G__10629__$1 = (((G__10629 == null))?null:(G__10629["type"]));
if((G__10629__$1 == null)){
return null;
} else {
return (G__10629__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__10631 = elem;
if((G__10631 == null)){
return null;
} else {
return (G__10631["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__10632._owner;
}
}
})();
var path = (function (){var G__10633 = owner;
var G__10633__$1 = (((G__10633 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__10633) : reagent.impl.component.component_path.call(null,G__10633)));
if((G__10633__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10633__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__10634 = c;
var G__10634__$1 = (((G__10634 == null))?null:G__10634.constructor);
if((G__10634__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__10634__$1);
}
}
})();
