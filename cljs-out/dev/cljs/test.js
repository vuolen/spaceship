...
var G__10211 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10211,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10211;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10213){
var G__10214 = cljs.core.first.call(null,seq10213);
var seq10213__$1 = cljs.core.next.call(null,seq10213);
var G__10215 = cljs.core.first.call(null,seq10213__$1);
var seq10213__$2 = cljs.core.next.call(null,seq10213__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10214,G__10215,seq10213__$2);
});
...
var file = cljs.core.get.call(null,map__10220__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10220__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10220__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__10220,map__10220__$1,file,line,column){
return (function (p1__10219_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10219_SHARP_));
});})(map__10220,map__10220__$1,file,line,column))
...
var temp__5457__auto___10222 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10222)){
var message_10223 = temp__5457__auto___10222;
cljs.core.println.call(null,message_10223);
} else {
}
...
var temp__5457__auto___10224 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10224)){
var message_10225 = temp__5457__auto___10224;
cljs.core.println.call(null,message_10225);
} else {
}
...
var output_dir__$1 = (function (){var G__10226 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__10226,"/"].join('');
} else {
return G__10226;
}
})();
...
var G__10228 = exception.stack;
var G__10228__$1 = (((G__10228 == null))?null:clojure.string.split_lines.call(null,G__10228));
var G__10228__$2 = (((G__10228__$1 == null))?null:cljs.core.get.call(null,G__10228__$1,depth));
if((G__10228__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10228__$2);
}
} else {
...
var vec__10229 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10229,(0),null);
var column = cljs.core.nth.call(null,vec__10229,(1),null);
var vec__10232 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10232,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10232,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10232,(2),null);
...
var m__$1 = (function (){var G__10235 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__10239 = (function (){var G__10238 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10238);
} else {
return G__10238;
}
})();
...
return cljs.core.vary_meta.call(null,G__10240,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__10244 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10244,(0),null);
var types = vec__10244;
...
return cljs.core.map.call(null,(function (p__10247){
var vec__10248 = p__10247;
var ns = cljs.core.nth.call(null,vec__10248,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10248,(1),null);
return ((function (vec__10248,ns,vars__$1){
return (function (){
...
var G__10251 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__10251,G__10251__$1,env,once_fixtures,each_fixtures,vec__10248,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__10251,G__10251__$1,env,once_fixtures,each_fixtures,vec__10248,ns,vars__$1){
return (function (){
var seq__10252 = cljs.core.seq.call(null,vars__$1);
var chunk__10253 = null;
var count__10254 = (0);
var i__10255 = (0);
while(true){
if((i__10255 < count__10254)){
var v = cljs.core._nth.call(null,chunk__10253,i__10255);
var temp__5457__auto___10257 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10257)){
var t_10258 = temp__5457__auto___10257;
each_fixture_fn.call(null,((function (seq__10252,chunk__10253,count__10254,i__10255,t_10258,temp__5457__auto___10257,v,each_fixture_fn,G__10251,G__10251__$1,env,once_fixtures,each_fixtures,vec__10248,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10258)));
});})(seq__10252,chunk__10253,count__10254,i__10255,t_10258,temp__5457__auto___10257,v,each_fixture_fn,G__10251,G__10251__$1,env,once_fixtures,each_fixtures,vec__10248,ns,vars__$1))
);
} else {
}


var G__10259 = seq__10252;
var G__10260 = chunk__10253;
var G__10261 = count__10254;
var G__10262 = (i__10255 + (1));
seq__10252 = G__10259;
chunk__10253 = G__10260;
count__10254 = G__10261;
i__10255 = G__10262;
continue;
} else {
...
var G__10263 = cljs.core.chunk_rest.call(null,seq__10252__$1);
var G__10264 = c__4550__auto__;
var G__10265 = cljs.core.count.call(null,c__4550__auto__);
var G__10266 = (0);
seq__10252 = G__10263;
chunk__10253 = G__10264;
count__10254 = G__10265;
i__10255 = G__10266;
continue;
} else {
var v = cljs.core.first.call(null,seq__10252__$1);
var temp__5457__auto___10267__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10267__$1)){
var t_10268 = temp__5457__auto___10267__$1;
each_fixture_fn.call(null,((function (seq__10252,chunk__10253,count__10254,i__10255,t_10268,temp__5457__auto___10267__$1,v,seq__10252__$1,temp__5457__auto__,each_fixture_fn,G__10251,G__10251__$1,env,once_fixtures,each_fixtures,vec__10248,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10268)));
});})(seq__10252,chunk__10253,count__10254,i__10255,t_10268,temp__5457__auto___10267__$1,v,seq__10252__$1,temp__5457__auto__,each_fixture_fn,G__10251,G__10251__$1,env,once_fixtures,each_fixtures,vec__10248,ns,vars__$1))
);
} else {
}


var G__10269 = cljs.core.next.call(null,seq__10252__$1);
var G__10270 = null;
var G__10271 = (0);
var G__10272 = (0);
seq__10252 = G__10269;
chunk__10253 = G__10270;
count__10254 = G__10271;
i__10255 = G__10272;
continue;
}
} else {
...
});})(each_fixture_fn,G__10251,G__10251__$1,env,once_fixtures,each_fixtures,vec__10248,ns,vars__$1))
);
});})(each_fixture_fn,G__10251,G__10251__$1,env,once_fixtures,each_fixtures,vec__10248,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10251__$1)].join('')));

}
})());
});
;})(vec__10248,ns,vars__$1))
