...
var G__10713 = o;
(G__10713[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__10715__i < G__10715__a.length) {G__10715__a[G__10715__i] = arguments[G__10715__i + 0]; ++G__10715__i;}
  args = new cljs.core.IndexedSeq(G__10715__a,0,null);
} 
...
var G__10717 = o;
(G__10717[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__10722 = props;
var G__10722__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10722,cljs.core.cst$kw$id,id):G__10722);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10722__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__10723){
...
var props = map__10724__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10724__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__10724,map__10724__$1,props,class$){
return (function (c){
...
});})(map__10724,map__10724__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10726){
var map__10727 = p__10726;
var map__10727__$1 = (((((!((map__10727 == null))))?(((((map__10727.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10727.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10727):map__10727);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10727__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__10727,map__10727__$1,on_write){
return (function (){
...
});})(node_value,map__10727,map__10727__$1,on_write))
);
} else {
...
var G__10730 = jsprops;
(G__10730["defaultValue"] = value);

(G__10730["onChange"] = ((function (G__10730,v,value,on_change){
return (function (p1__10729_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__10729_SHARP_);
});})(G__10730,v,value,on_change))
);
...
var vec__10733 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10733,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10733,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10733,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___10737 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___10737 == null)){
} else {
var key_10738 = temp__5461__auto___10737;
(jsprops["key"] = key_10738);
}
...
var temp__5461__auto___10739 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___10739 == null)){
} else {
var key_10740 = temp__5461__auto___10739;
reagent.impl.template.oset(jsprops,"key",key_10740);
}
...
var G__10741 = reagent.impl.template.__GT_NativeWrapper();
(G__10741["name"] = c);
...
var G__10742 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10742) : reagent.impl.template.as_element.call(null,G__10742));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10746){
var G__10747 = cljs.core.first(seq10746);
var seq10746__$1 = cljs.core.next(seq10746);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10747,seq10746__$1);
});
...
break;
default:
var G__10753 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__10753;
continue;
...
var n__4607__auto___10755 = a.length;
var i_10756 = (0);
while(true){
if((i_10756 < n__4607__auto___10755)){
(a[i_10756] = reagent.impl.template.as_element((a[i_10756])));

var G__10757 = (i_10756 + (1));
i_10756 = G__10757;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___10758 = a.length;
var i_10759 = (0);
while(true){
if((i_10759 < n__4607__auto___10758)){
var val_10760 = (a[i_10759]);
if(((cljs.core.vector_QMARK_(val_10760)) && ((reagent.impl.template.key_from_vec(val_10760) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10759] = reagent.impl.template.as_element(val_10760));
...
var ctx = ({});
var vec__10762 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10762,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10762,(1),null);
...
var G__10765 = (cljs.core.count(argv) - first_child);
switch (G__10765) {
case (0):
...
case (1):
var G__10766 = comp;
var G__10767 = jsprops;
var G__10768 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__10766,G__10767,G__10768) : reagent.impl.template.global$module$react.createElement.call(null,G__10766,G__10767,G__10768));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__10765){
